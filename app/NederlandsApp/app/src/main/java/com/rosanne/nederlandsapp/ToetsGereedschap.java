...
public class ToetsGereedschap extends AppCompatActivity {
    ...
    public final String[] list = {"de habijl", "de schroef", "de boormachine","de schroevendraaier","de schaar","de hamer","de bezem","het stoffer en blik"};
    public String woord;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_toetsgereedschap);
